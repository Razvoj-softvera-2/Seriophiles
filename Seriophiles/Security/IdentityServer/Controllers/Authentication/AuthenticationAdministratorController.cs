...
[ApiController]
public class AuthenticationAdministratorController : RegistrationControllerBase
{
    public AuthenticationAdministratorController(ILogger<AuthenticationUserController> logger, IMapper mapper, IUserRepository userRepository, IRoleRepository roleRepository, IAuthenticationService authService) 
